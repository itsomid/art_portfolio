                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="first_name" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="last_name"  required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">هنر اصلی</label>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="art_category">
                                    ...
                                    <option value="visual">هنر تجسمی</option>
                                    <option value="painting" >هنر ترسیمی</option>
                                    <option value="performing">حرکات نمایشی</option>
